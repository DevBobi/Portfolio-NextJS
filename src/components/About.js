			...
			>
				<div className="flex flex-col justify-center items-center md:pr-6 md:border-r-4 border-blue-400">
					<motion.div whileTap={{ scale: 0.9 }} className="relative h-48 w-48">
						...
						<Image
							...
							alt="bobi's photo"
							src={require("../media/profile1.jpg")}
							layout="fill"
							objectFit="cover"
						/>
					</motion.div>
				...
				<div>
					<p className="text-lg sm:text-xl md:text-2xl dark:text-gray-400">
						Hi, I am Saifur Rahaman. I am a MERN stack web developer. I am working as a student right now & also developed some mature full stack websites.
					</p>
